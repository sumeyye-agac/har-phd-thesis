...
All models are saved and results are written to results/grid_search_lm_att.csv
"""
...
Examples:
  ...
  python ch5_grid_search_lm_att.py ch_att=true sp_att=false cbam=false
  
  # Run ch_att with only ratio 2 and 4, on layers 1 and 2
  python ch5_grid_search_lm_att.py ch_att=true sp_att=false cbam=false channel_ratios=2,4 layer_positions=1,2
  
  # Run all (default)
  python ch5_grid_search_lm_att.py
  
  # Case-insensitive (all work the same)
  python ch5_grid_search_lm_att.py CH_ATT=true ch_att=false Ch_Att=true

Note: All parameters are case-insensitive. Invalid parameters or values will stop execution.
""",
    'script_name': 'ch5_grid_search_lm_att.py'
}
...
def main():
    ...
    logger.info("=== Chapter 5: LM-Att Grid Search ===")
    ...
    csv_path = "results/grid_search_lm_att.csv"
